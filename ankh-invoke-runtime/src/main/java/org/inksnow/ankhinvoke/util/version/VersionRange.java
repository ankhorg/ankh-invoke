...
public class VersionRange {
  ...
  private VersionRange(ComparableVersion recommendedVersion, List<Restriction> restrictions) {
  ...
  public static VersionRange createFromVersion(String version) {
    ...
    if (cached == null) {
      ...
      cached = new VersionRange(new ComparableVersion(version), restrictions);
  ...
  public ComparableVersion getSelectedVersion() {
    return recommendedVersion;
  }
