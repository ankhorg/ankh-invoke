...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/NBTTagString", predicates = "craftbukkit_version:[v1_12_R1,)")
public final class RefNbtTagString extends RefNbtBase {
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_15_R1/NBTTagString;a(Ljava/lang/String;)Lnet/minecraft/server/v1_15_R1/NBTTagString;", predicates = "craftbukkit_version:[v1_15_R1,)")
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_13_R1/NBTTagString;asString()Ljava/lang/String;", predicates = "craftbukkit_version:[v1_13_R1,)")
  @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagString;c_()Ljava/lang/String;", predicates = "craftbukkit_version:[v1_12_R1,)")
