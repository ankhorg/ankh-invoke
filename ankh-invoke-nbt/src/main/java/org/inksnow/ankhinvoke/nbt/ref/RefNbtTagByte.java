...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/NBTTagByte", predicates = "craftbukkit_version:[v1_12_R1,)")
public final class RefNbtTagByte extends RefNbtNumber {
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_15_R1/NBTTagByte;a(B)Lnet/minecraft/server/v1_15_R1/NBTTagByte;", predicates = "craftbukkit_version:[v1_15_R1,)")
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_15_R1/NBTTagByte;a(Z)Lnet/minecraft/server/v1_15_R1/NBTTagByte;", predicates = "craftbukkit_version:[v1_15_R1,)")
