...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/NBTTagDouble", predicates = "craftbukkit_version:[v1_12_R1,)")
public final class RefNbtTagDouble extends RefNbtNumber {
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_15_R1/NBTTagDouble;a(D)Lnet/minecraft/server/v1_15_R1/NBTTagDouble;", predicates = "craftbukkit_version:[v1_15_R1,)")
