...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/NBTTagList", predicates = "craftbukkit_version:[v1_12_R1,)")
public final class RefNbtTagList extends RefNbtBase {
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagList;<init>()V", predicates = "craftbukkit_version:[v1_12_R1,)")
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_14_R1/NBTTagList;get(I)Lnet/minecraft/server/v1_14_R1/NBTBase;", predicates = "craftbukkit_version:[v1_14_R1,)")
  @HandleBy(reference = "Lnet/minecraft/server/v1_13_R1/NBTTagList;c(I)Lnet/minecraft/server/v1_13_R1/NBTBase;", predicates = "craftbukkit_version:[v1_13_R1,)")
  @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagList;i(I)Lnet/minecraft/server/v1_12_R1/NBTBase;", predicates = "craftbukkit_version:[v1_12_R1,)")
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagList;size()I", predicates = "craftbukkit_version:[v1_12_R1,)")
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_13_R1/NBTTagList;set(ILnet/minecraft/server/v1_13_R1/NBTBase;)Lnet/minecraft/server/v1_13_R1/NBTBase;", predicates = "craftbukkit_version:[v1_13_R1,)")
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_14_R1/NBTTagList;add(ILnet/minecraft/server/v1_14_R1/NBTBase;)V", predicates = "craftbukkit_version:[v1_14_R1,)")
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagList;remove(I)Lnet/minecraft/server/v1_12_R1/NBTBase;", predicates = "craftbukkit_version:[v1_12_R1,)")
