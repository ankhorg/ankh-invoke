...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/NBTTagShort", predicates = "craftbukkit_version:[v1_12_R1,)")
public final class RefNbtTagShort extends RefNbtNumber {
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_15_R1/NBTTagShort;a(S)Lnet/minecraft/server/v1_15_R1/NBTTagShort;", predicates = "craftbukkit_version:[v1_15_R1,)")
