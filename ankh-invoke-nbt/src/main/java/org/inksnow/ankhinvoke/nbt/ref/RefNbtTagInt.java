...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/NBTTagInt", predicates = "craftbukkit_version:[v1_12_R1,)")
public final class RefNbtTagInt extends RefNbtNumber {
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_15_R1/NBTTagInt;a(I)Lnet/minecraft/server/v1_15_R1/NBTTagInt;", predicates = "craftbukkit_version:[v1_15_R1,)")
