...
public class TestTargets {
  ...
  private void testNbtByteArray() {
    ...
    final List<Byte> VALUE_A_LIST = Arrays.asList(VALUE_A[0], VALUE_A[1], VALUE_A[2], VALUE_A[3]);
  ...
  private void testNbtComponentLike(NbtComponentLike compound) {
    ...
    compound.putByteArray("TestByteArray2", Arrays.asList((byte) 2, (byte) 3, (byte) 4));
    ...
    compound.putIntArray("TestIntArray2", Arrays.asList(2, 3, 4));
    ...
    compound.putLongArray("TestLongArray2", Arrays.asList(2L, 3L, 4L));
  ...
  private void testNbtIntArray() {
    ...
    final List<Integer> VALUE_A_LIST = Arrays.asList(VALUE_A[0], VALUE_A[1], VALUE_A[2], VALUE_A[3]);
  ...
  private void testNbtLongArray() {
    ...
    final List<Long> VALUE_A_LIST = Arrays.asList(VALUE_A[0], VALUE_A[1], VALUE_A[2], VALUE_A[3]);
