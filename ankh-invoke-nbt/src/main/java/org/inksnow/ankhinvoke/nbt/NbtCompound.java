...
import org.inksnow.ankhinvoke.nbt.internal.DelegateAbstractMap;
import org.inksnow.ankhinvoke.nbt.internal.LazyLoadEntrySet;
import org.inksnow.ankhinvoke.nbt.internal.StringUtils;
import org.inksnow.ankhinvoke.nbt.ref.*;
...
public class NbtCompound extends Nbt<RefNbtTagCompound> implements NbtComponentLike {
  private static final boolean SET_RETURN_SUPPORT = CraftBukkitVersion.v1_14_R1.isSupport();
  private static final boolean LONG_ARRAY_SUPPORT = CraftBukkitVersion.v1_13_R1.isSupport();
  private static final boolean PUT_BYTE_LIST_SUPPORT = CraftBukkitVersion.v1_17_R1.isSupport();
  private static final boolean PUT_INT_LIST_SUPPORT = CraftBukkitVersion.v1_13_R1.isSupport();
