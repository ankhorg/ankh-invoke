...
@HandleBy(reference = "net/minecraft/server/v1_12_R1/NBTTagIntArray", predicates = "craftbukkit_version:[v1_12_R1,)")
public final class RefNbtTagIntArray extends RefNbtBase {
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagIntArray;<init>([I)V", predicates = "craftbukkit_version:[v1_12_R1,)")
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagIntArray;<init>(Ljava/util/List;)V", predicates = "craftbukkit_version:[v1_12_R1,)")
  ...
  @HandleBy(reference = "Lnet/minecraft/server/v1_14_R1/NBTTagIntArray;getInts()[I", predicates = "craftbukkit_version:[v1_14_R1,)")
  @HandleBy(reference = "Lnet/minecraft/server/v1_12_R1/NBTTagIntArray;d()[I", predicates = "craftbukkit_version:[v1_12_R1,)")
